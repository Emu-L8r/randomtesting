...
- planets are placed on 11 selected valid slots, which keeps each planet tooth phase compatible with both sun and fixed ring meshes while avoiding collisions.
